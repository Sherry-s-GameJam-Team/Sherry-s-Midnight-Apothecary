...
const MODE_GROUND := 0
const MODE_FLIGHT := 1
const TOWN_FRAMES = preload("res://art/shared/characters/lost_ruins_witch/lost_ruins_witch_sprite_frames.tres")
const FLIGHT_FRAMES = preload("res://art/shared/characters/witch/witch_sprite_frames.tres")
