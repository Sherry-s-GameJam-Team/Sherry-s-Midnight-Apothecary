...
const HOME_TEXTURE = preload("res://game/main/scenes/town/resource/pic/home.png")
const HOME_INSIDE_TEXTURE = preload("res://game/main/scenes/town/resource/pic/home_inside.png")
const HOME_INSIDE_SHADOW_TEXTURE = preload("res://game/main/scenes/town/resource/pic/home_inside_shadow.png")
