...
static func run(test: TestSupport) -> void:
	...
	for scene_path: String in [
		...
		"res://day/levels/_tests/dual_world_tree_tower/tree_tower_demo.tscn",
		"res://day/levels/_tests/dual_world_tree_tower/corrupted_alignment_preview.tscn",
		"res://day/levels/_tests/dual_world_tree_tower/original_alignment_preview.tscn",
