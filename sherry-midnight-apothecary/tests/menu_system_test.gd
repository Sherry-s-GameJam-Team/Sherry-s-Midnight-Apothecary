...
static func run(test: TestSupport) -> void:
	...
	test.expect_equal(tree_silhouette.texture.resource_path, "res://menu/effects/tree.png", "Menu tree uses the supplied silhouette texture.")
	test.expect_equal(bird_silhouette.texture.resource_path, "res://menu/effects/bird.png", "Menu birds use the supplied silhouette texture.")
