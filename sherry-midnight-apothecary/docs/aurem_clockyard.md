...
| **第四层** (Y: -3200 ~ -4200) | **指针层** (Clock Hands Floor) | **双轴齿轮联动钟面校调**：取消原回弹机制，配备独立的分针手轮与时针手轮。遵循双向齿轮传动比：**分针转动 3 次时针额外转动 1 次；时针转动 1 次分针额外转动 9 次**。调校使分针指向 Ⅲ 开启密室，指向 Ⅻ 对齐通向塔顶之路 | **开启塔顶登顶通道** |
