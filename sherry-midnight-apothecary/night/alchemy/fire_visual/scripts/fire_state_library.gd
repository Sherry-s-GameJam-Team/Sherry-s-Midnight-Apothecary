...
@export_file("*.json") var manifest_path := "res://night/alchemy/fire_visual/assets/microstates/state_manifest.json"
@export_dir var asset_root := "res://night/alchemy/fire_visual/assets/microstates"
